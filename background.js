...
browser.contextMenus.create({
    id: "context-digi-sel",
    title: "Hae valittu teksti Digi.kansalliskirjasto.fi:stä",
    contexts: ["selection"],
});
...
browser.contextMenus.onClicked.addListener((info, tab) => {
    ...
    if (info.menuItemId === "context-digi-sel") {

        var sText = '"' + info.selectionText + '"';
        console.log(sText);
        var miurl = "https://digi.kansalliskirjasto.fi/search?formats=NEWSPAPER&query=" + encodeURIComponent(sText);
